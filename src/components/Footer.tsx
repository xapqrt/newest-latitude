    ...
    <footer className="footer">
      ...
      <div className="footer-inner">
        ...
        <div className="footer-wa-cta">
          <a
            href="https://wa.me/919876543210?text=Hi%20Latitude%2C%20I%27d%20like%20to%20know%20more!"
            target="_blank"
            ...
            <ul>
              <li>
                <svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                 <a href="mailto:hello@latitudeoutdoors.in">hello@latitudeoutdoors.in</a>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <p>© 2026 Latitude. All rights reserved.</p>
