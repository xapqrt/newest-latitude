    ...
    <div ref={pageRef}>
      ...
      <div className="pd-hero">
        <div
          ...
          style={{ backgroundImage: `url(${optimizeImage('https://images.pexels.com/photos/2559941/pexels-photo-2559941.jpeg?auto=compress&cs=tinysrgb&w=1920')})` }}
        />
      ...
      <section className="pd-overview">
        <div className="pd-overview__inner">
          ...
          <div className="pd-overview__img" style={{ opacity: 0 }}>
            <img
              src={optimizeImage('https://images.pexels.com/photos/2559941/pexels-photo-2559941.jpeg?auto=compress&cs=tinysrgb&w=900')}
              srcSet={imageSrcSet('https://images.pexels.com/photos/2559941/pexels-photo-2559941.jpeg?auto=compress&cs=tinysrgb&w=900')}
